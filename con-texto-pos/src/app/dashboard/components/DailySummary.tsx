...
export default function DailySummary({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
      ...
      {/* Ventas realizadas */}
      <div className="bg-[#FFFDD0] border border-blue-200 rounded-2xl p-6">
        <p className="text-sm text-gray-600 mb-2">Ventas realizadas</p>
        <p className="text-3xl font-bold text-blue-900">{confirmedSales}</p>
      ...
      <div className="bg-[#FFFDD0] border border-blue-200 rounded-2xl p-6">
        ...
        <p className="text-3xl font-bold text-blue-900">${averageTicket.toFixed(2)}</p>
      ...
      <div className="bg-[#FFFDD0] border border-blue-200 rounded-2xl p-6">
        ...
        <p className="text-3xl font-bold text-blue-600">${estimatedProfit.toFixed(2)}</p>
